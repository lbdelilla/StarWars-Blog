  ...
  return (
    <section className="bg-black">
      ...
      <Link to="/" className="flex flex-row justify-center">
        <span
          className="text-white bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-3 py-2 text-center inline-flex items-center"
          href="#"
          role="button"
        >
          Back home
