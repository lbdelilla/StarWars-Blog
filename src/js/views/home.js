      ...
      {hasSearchResults ? (
        ...
        <section className="bg-black">
          <ContentSection
            ...
            data={people}
            type="people"
            onClickLoadMore={() => handleClick(people_next_page, 'people')}
          />
          <ContentSection
            title="Planets"
            image={Planet}
            data={planets}
            type="planets"
            onClickLoadMore={() => handleClick(planets_next_page, 'planets')}
          />
          <ContentSection
            title="Starships"
            image={Starship}
          ...
          <ContentSection
            ...
            data={vehicles}
            type="vehicles"
            onClickLoadMore={() => handleClick(vehicles_next_page, 'vehicles')}
          />
          <ContentSection
            title="Species"
            image={Species}
            data={species}
            type="species"
            onClickLoadMore={() => handleClick(species_next_page, 'species')}
          />
          <div className="chatbot-container">
            <Chat />
          </div>
